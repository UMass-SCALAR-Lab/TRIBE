...
# ]
# ///
"""Throwaway diagnostic: same base-vs-DPO length/termination check already run for Llama-MATH-DPO, now for
Qwen-MATH-DPO, to check whether the same likelihood-displacement / degraded-termination mechanism explains
Qwen's regression too. Delete after use."""
